...
public class JsonCacheUtil {
    ...
    private JsonCacheUtil() {
        mSharedPreferences = BaseApplication.getAppContent().getSharedPreferences(JSON_CACHE_SP_NAME, Context.MODE_PRIVATE);
        mGson = new Gson();
    }
    ...
    public void saveCache(String key, Object value, long duration) {
        ...
        //保存一个有数据有时间的内容
        CacheWithDuration withDuration = new CacheWithDuration(duration, valueStr);
        String cacheWithTime = mGson.toJson(withDuration);
